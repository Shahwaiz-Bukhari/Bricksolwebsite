...
const PortfolioGoal = () => {
  ...
  const data = {
    slide: [
      {
        text: "Delivering AI-powered solutions that fuel business growth with smarter insights and automation.",
        image: "/images/portfolio/goal-slide1.webp",
      },
      {
        text: "Creating scalable eCommerce platforms that boost sales, personalization, and customer loyalty.",
        image: "/images/portfolio/goal-slide2.webp",
      },
      {
        text: "Transforming industries with intelligent digital tools for healthcare, retail, and education.",
        image: "/images/portfolio/goal-slide3.webp",
      },
    ],
  };
